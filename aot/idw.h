#ifndef HALIDE__idw_h
#define HALIDE__idw_h
#include <stdint.h>
...
int idw(struct halide_buffer_t *_idw_buffer);

HALIDE_FUNCTION_ATTRS
int idw_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *idw_metadata();
